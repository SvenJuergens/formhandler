...
class Form extends AbstractController
{
     ...
     *
     * @param string $action The action to perform. This must equal "show" for a
     * print version or an action defined in the config of Finisher_SubmittedOK
    ...
    protected function processSubmitted()
    {
        ...
        $this->addFormhandlerClass(
            $this->settings['initInterceptors.'],
            '\Typoheads\Formhandler\Interceptor\RemoveXSS'
        );
    ...
    /**
     * Stores file names of uploaded files into the internal
     * GET/POST parameters storage ($this->gp) so that they can be used
     * later on in "value markers", userFuncs, ...
     */
     ...
     *
     * @param array &$settings Reference to the settings array to get information
     * about checkboxes and radiobuttons.
     */
